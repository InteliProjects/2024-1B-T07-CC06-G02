...
def calculate_travel_time(prev_point, next_point, velocity=5):
...
def calculate_total_duration(current_duration, travel_time, len_route, read_time=2):
    # reading_time_per_point = 0.04  # Average reading time per point in hours

    reading_time_per_point = read_time / 60  # Convert minutes to hours
...
def build_points_df(routes, durations) -> pd.DataFrame:
    """
